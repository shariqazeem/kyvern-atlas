  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="rounded-xl border border-black/[0.06] bg-white p-5 space-y-3">
        ...
        <div className="h-3 w-full bg-[var(--surface-2)] rounded animate-pulse" />
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="rounded-xl border border-black/[0.06] bg-white p-4 space-y-2">
            ...
            <div className="h-6 w-24 bg-[var(--surface-3)] rounded animate-pulse" />
          </div>
        ))}
      </div>
      {/* Chart skeleton */}
      <div className="rounded-xl border border-black/[0.06] bg-white p-4">
        <div className="h-48 bg-[var(--surface-2)] rounded-lg animate-pulse" />
      </div>
      {/* Tables skeleton */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        {[...Array(2)].map((_, i) => (
          <div key={i} className="rounded-xl border border-black/[0.06] bg-white p-4 space-y-3">
            ...
            {[...Array(5)].map((_, j) => (
              <div key={j} className="h-3 w-full bg-[var(--surface-2)] rounded animate-pulse" />
            ))}
          </div>
        ))}
      </div>
