...
const PERSONAS: Record<string, Persona> = {
  ...
  loyalist: {
    ...
    emoji: "",
    color: "#8b5cf6",
    description: "Active 14+ days, consistent usage",
  },
  explorer: {
    name: "Explorer",
    emoji: "",
    color: "#f59e0b",
    description: "Uses 3+ different endpoints",
  },
  researcher: {
    name: "Researcher",
    emoji: "",
    color: "#06b6d4",
    description: "Data, search, and analytics focus",
  },
  trader: {
    name: "Trader",
    emoji: "",
    color: "#10b981",
    description: "Price, oracle, and DeFi focus",
  },
  newcomer: {
    name: "New",
    emoji: "",
  ...
  regular: {
    ...
    emoji: "",
    color: "#78716c",
    description: "Steady usage pattern",
  },
};
