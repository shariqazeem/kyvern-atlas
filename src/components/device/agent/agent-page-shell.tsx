    ...
    <PageHeader
      ...
      left={
        <>
          ...
          <span
            className="font-mono uppercase tracking-[0.14em] hidden md:inline truncate"
            style={{ fontSize: 9.5, color: "rgba(15,23,42,0.50)" }}
          >
            {serial}
          </span>
        </>
  ...
  const primaryZone = (
    <>
      ...
      <Card>
        ...
        <h3
          className="text-[18px] font-semibold tracking-[-0.01em] mb-1.5"
          style={{ color: "#0A0A0A" }}
        >
          {templateLabel(agent.template)}
        </h3>
      ...
      {/* 3. Observability card */}
      <Card>
        <Eyebrow>Observability</Eyebrow>
        <div className="grid grid-cols-3 gap-3">
          <Stat
            label="Watching"
            value={agent.template === "bounty_hunter"
              ? "Ecosystem feeds"
          ...
          <Stat
            ...
            tone={
              isPaused ? "amber" : isAlive ? "green" : "gray"
            }
          />
        </div>
        <div
  ...
  const secondaryZone = (
    <>
      ...
      <Card>
        ...
        <div className="flex flex-col gap-2 max-h-[280px] overflow-y-auto mb-3 pr-1">
          {chat.length === 0 && (
            <div
